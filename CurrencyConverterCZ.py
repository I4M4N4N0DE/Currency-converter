...
def Gui():
        ...
        b2 = tkin.Button(buttonwin, text="$ --> CZK", command=lambda:main(24.512)).place(x=110, y=20) # zde si můžete změnit aktuální měnový kurz pro daný převod (lambda:main(aktuální kurz v desetinném zápise))
        ...
        b4 = tkin.Button(buttonwin, text="€ --> CZK", command=lambda:main(0.40841)).place(x=110, y=80) # zde si můžete změnit aktuální měnový kurz pro daný převod (lambda:main(aktuální kurz v desetinném zápise))
        ...
        b6 = tkin.Button(buttonwin, text="€ --> $", command=lambda:main(0.998898)).place(x=118, y=130) # zde si můžete změnit aktuální měnový kurz pro daný převod (lambda:main(aktuální kurz v desetinném zápise))
